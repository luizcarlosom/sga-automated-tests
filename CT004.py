...
def ct0004() -> None:
    ...
    xpath_search_student_link = '//*[@id="navMobile"]/a[3]'
    search_student_link = browser.find_element('xpath', xpath_search_student_link)
    search_student_link.click()

    xpath_stundet_active_link = '/html/body/div/div/div[1]/div/a'
    stundet_active_link = browser.find_element('xpath', xpath_stundet_active_link)
    stundet_active_link.click()
